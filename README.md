...
**Additional make watch notes**

Needed to install openssl via vcpkg:
...
Downloaded cacert.pem from: https://curl.se/docs/caextract.html, put in a folder on local file system.
...
export SSL_CERT_FILE=~/src/Documents/certs/cacert.pem
```

As per: https://stackoverflow.com/a/66197124/645132
